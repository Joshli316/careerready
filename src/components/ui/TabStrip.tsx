      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`rounded-lg px-3 py-1.5 min-h-[44px] items-center text-sm font-medium whitespace-nowrap focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 ${
              isActive
