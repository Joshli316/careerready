...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary: "border border-primary-400 text-primary-400 hover:bg-primary-50 focus:ring-primary-400",
  ghost: "text-neutral-600 hover:bg-neutral-100 focus:ring-neutral-400",
  danger: "bg-error text-white hover:bg-red-600 focus:ring-error",
  ai: "bg-ai-accent text-white hover:bg-purple-600 focus:ring-ai-accent",
};
