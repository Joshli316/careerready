  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-neutral-500">{t("socialMedia.description")}</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {platformKeys.map((key) => (
          <a key={key} href={platformUrls[key]} target="_blank" rel="noopener noreferrer" className="group rounded-xl border border-neutral-150 bg-white p-5 shadow-sm transition-[shadow,border-color] hover:shadow-md hover:border-primary-300">
            <h3 className="font-semibold text-neutral-800 group-hover:text-primary-400">{t(`socialMedia.platformTips.${key}.name`)}</h3>
